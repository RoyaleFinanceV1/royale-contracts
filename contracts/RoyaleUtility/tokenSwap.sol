...
contract GradualTokenSwap is ERC20Recovery {
    ...
    /**
     * @dev Creates a contract that can be used for swapping mROYA into ROYA
     * @param _start UNIX time at which the unlock period starts
     * @param _duration Duration in seconds for unlocking tokens
     */
    constructor (uint256 _start, uint256 _duration, IERC20 _mROYA, IERC20 _ROYA) public {
    ...
    /**
     * @dev Provide mROYA tokens to the contract for later exchange
     */
    function provide(uint amount) external {
      mROYA.safeTransferFrom(msg.sender, address(this), amount);
      provided[msg.sender] = provided[msg.sender].add(amount);
    }

    /**
     * @dev Withdraw unlocked user's ROYA tokens
     */
    function withdraw() external {
        ...
        ROYA.safeTransfer(msg.sender, amount);
